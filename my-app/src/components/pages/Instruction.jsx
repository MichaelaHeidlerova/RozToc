...
<div className="pageContent">
  <p className="guide-paragraph">
    Vítejte v nástroji pro efektivní správu tříd a žáků a tvorbu skupin! Následující kroky Vás provedou klíčovými funkcemi.
  </p>
    
  <div className="guide-Content">
    <h3 className="guide-subheading">1. Založení třídy a přidání žáků</h3>
    <p className="guide-paragraph"><strong>Založení třídy:</strong> Po přihlášení klikněte na tlačítko "Správa tříd". Zadejte název třídy (např. 7.A) a uložte.</p>
    <p className="guide-paragraph"><strong>Přidání žáků:</strong> V přehledu tříd vyberte nově vytvořenou třídu a klikněte na "Přidat žáka". Zadejte jméno žáka a volitelně doplňte jeho vlastnosti:</p>
  ...
  <div className="guide-section">
    ...
    <p className="guide-paragraph">Máte dvě možnosti, jak tvořit skupiny:</p>
    <ul className="guide-list">
    ...
    <p className="guide-paragraph">Zohlednění vlastností žáků při tvorbě skupin:</p>
    <ul className="guide-list">
  ...
  <div className="guide-section">
    ...
    <p className="guide-paragraph">Po vytvoření skupin můžete každému žákovi v rámci jeho skupiny přiřadit specifické role:</p>
    <ul className="guide-list">
      <li>Kapitán</li>
      <li>Zapisovatel</li>
      <li>Prezentátor</li>
  ...
  <div className="guide-section">
    <h3 className="guide-subheading">5. Odpočet času pro skupinovou práci</h3>
    <p className="guide-paragraph">
